...
namespace CryptoUtilsConsole
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Textul criptat :" + BitConverter.ToString(encrypted).Replace("-", ""));
            byte[] decrypted = DESCrypto(Mode.DECRYPT, IV, key, encrypted);
            Console.WriteLine("Textul decriptat :" + Encoding.UTF8.GetString(decrypted));
            Console.ReadLine();
